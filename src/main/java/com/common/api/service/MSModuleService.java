...
import com.common.api.resultset.ModuleResultset;
import com.common.api.util.ResultSetConversion;

@Service
public class MSModuleService extends APIFixedConstant implements ModuleService {
	...
	public List<Module> viewListByCriteria(String companyId, String groupId, String divisionId, String id, String name, String code, String category, List<String> statusList, List<String> typeList, String sortBy, String sortOrder, int offset, int limit) {
		...
		if (selQuery.length() > 0) {
			...
			selQuery = "select * from " + TB_MODULE + " where " + selQuery;
			return namedParameterJdbcTemplate.query(selQuery, parameters, new ModuleResultset());
		}
