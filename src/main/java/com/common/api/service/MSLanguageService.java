...
import com.common.api.resultset.LanguageResultset;
import com.common.api.util.ResultSetConversion;

@Service
public class MSLanguageService extends APIFixedConstant implements LanguageService {
	...
	@Override
	public List<Language> viewListByCriteria(String companyId, String id, String name, String code, List<String> statusList, List<String> typeList, String sortBy, String sortOrder, int offset, int limit) {
		...
		if (selQuery.length() > 0) {
			...
			selQuery = "select * from " + TB_LANGUAGE + " where " + selQuery;
			return namedParameterJdbcTemplate.query(selQuery, parameters, new LanguageResultset());
		}
