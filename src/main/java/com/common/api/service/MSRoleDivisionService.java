...
import com.common.api.resultset.RoleDivisionResultset;
import com.common.api.util.ResultSetConversion;

@Service
public class MSRoleDivisionService extends APIFixedConstant implements RoleDivisionService {
	...
	public List<RoleDivision> viewListByCriteria(String companyId, String divisionId, String id, List<String> statusList, List<String> typeList, String sortBy, String sortOrder, int offset, int limit) {
		...
		if (selQuery.length() > 0) {
			...
			selQuery = "select * from " + TB_ROLE_DIVISION + " where " + selQuery;
			return namedParameterJdbcTemplate.query(selQuery, parameters, new RoleDivisionResultset());
		}
