...
import com.common.api.resultset.CompanyResultset;
import com.common.api.util.ResultSetConversion;

@Service
public class MSCompanyService extends APIFixedConstant implements CompanyService {
	...
	@Override
	public List<Company> viewListByCriteria(String id, String name, String code, String category, List<String> statusList, List<String> typeList, String sortBy, String sortOrder, int offset, int limit) {
		...
		if (selQuery.length() > 0) {
			...
			selQuery = "select * from " + TB_COMPANY + " where " + selQuery;
			return namedParameterJdbcTemplate.query(selQuery, parameters, new CompanyResultset());
		}
