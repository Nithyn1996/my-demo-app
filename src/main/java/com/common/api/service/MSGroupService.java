...
import com.common.api.resultset.GroupResultset;
import com.common.api.util.ResultSetConversion;

@Service
public class MSGroupService extends APIFixedConstant implements GroupService {
	...
	public List<Group> viewListByCriteria(String companyId, String id, String name, String code, String category, List<String> statusList, List<String> typeList, String sortBy, String sortOrder, int offset, int limit) {
		...
		if (selQuery.length() > 0) {
			...
			selQuery = "select * from " + TB_GROUP + " where " + selQuery;
			return namedParameterJdbcTemplate.query(selQuery, parameters, new GroupResultset());
		}
