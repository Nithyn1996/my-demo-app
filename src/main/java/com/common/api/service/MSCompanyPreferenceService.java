...
import com.common.api.resultset.CompanyPreferenceResultset;
import com.common.api.util.ResultSetConversion;

@Service
public class MSCompanyPreferenceService extends APIFixedConstant implements CompanyPreferenceService {
	...
	public List<CompanyPreference> viewListByCriteria(String companyId, String id, String name, String category, List<String> statusList, List<String> typeList, String sortBy, String sortOrder, int offset, int limit) {
		...
		if (selQuery.length() > 0) {
			...
			selQuery = "select * from " + TB_COMPANY_PREF + " where " + selQuery;
			return namedParameterJdbcTemplate.query(selQuery, parameters, new CompanyPreferenceResultset());
		}
