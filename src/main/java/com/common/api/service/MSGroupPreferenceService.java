...
import com.common.api.resultset.GroupPreferenceResultset;
import com.common.api.util.ResultSetConversion;

@Service
public class MSGroupPreferenceService extends APIFixedConstant implements GroupPreferenceService {
	...
	public List<GroupPreference> viewListByCriteria(String companyId, String groupId, String id, String name, String category, List<String> statusList, List<String> typeList, String sortBy, String sortOrder, int offset, int limit) {
		...
		if (selQuery.length() > 0) {
			...
			selQuery = "select * from " + TB_GROUP_PREF + " where " + selQuery;
			return namedParameterJdbcTemplate.query(selQuery, parameters, new GroupPreferenceResultset());
		}
