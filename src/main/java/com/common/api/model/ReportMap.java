...
@ApiModel(value = "reportMap")
@TypeAlias(value = "reportMap")
@JsonIgnoreProperties(
	ignoreUnknown = true
	, value = { "active", "createdBy", "modifiedBy", "createdAt", "modifiedAt" }
	, allowGetters = false, allowSetters = false)
public class ReportMap extends APIFixedConstant {
	...
	@Size(min = FL_TYPE_MIN, max = FL_TYPE_MAX, message = EM_INVALID_REPORT_TYPE)
	@Pattern(regexp = RE_TYPE, message = EM_INVALID_REPORT_TYPE + EM_INVALID_PATTERN)
	...
	public String toString() {
		return "ReportMap [Id=" + Id + ", companyId=" + companyId + ", groupId=" + groupId + ", divisionId="
				+ divisionId + ", moduleId=" + moduleId + ", name=" + name + ", procedureName=" + procedureName
				+ ", reportType=" + reportType + ", active=" + active + ", createdBy=" + createdBy + ", modifiedBy="
