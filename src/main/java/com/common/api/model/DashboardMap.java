...
@ApiModel(value = "dashboardMap")
@TypeAlias(value = "dashboardMap")
@JsonIgnoreProperties(
	ignoreUnknown = true
	, value = { "active", "createdBy", "modifiedBy", "createdAt", "modifiedAt" }
	, allowGetters = false, allowSetters = false)
public class DashboardMap extends APIFixedConstant {
	...
	@Size(min = FL_TYPE_MIN, max = FL_TYPE_MAX, message = EM_INVALID_DASHBOARD_TYPE)
	@Pattern(regexp = RE_TYPE, message = EM_INVALID_DASHBOARD_TYPE + EM_INVALID_PATTERN)
	@ApiModelProperty(value = "dashboardType", required = true)
    @JsonProperty(value = "dashboardType")
	...
	public String toString() {
		return "DashboardMap [Id=" + Id + ", companyId=" + companyId + ", groupId=" + groupId + ", divisionId="
				+ divisionId + ", moduleId=" + moduleId + ", name=" + name + ", procedureName=" + procedureName
				+ ", dashboardType=" + dashboardType + ", active=" + active + ", createdBy=" + createdBy
