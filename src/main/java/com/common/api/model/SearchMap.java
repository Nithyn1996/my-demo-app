...
@ApiModel(value = "searchMap")
@TypeAlias(value = "searchMap")
@JsonIgnoreProperties(
	ignoreUnknown = true
	, value = { "active", "createdBy", "modifiedBy", "createdAt", "modifiedAt" }
	, allowGetters = false, allowSetters = false)
public class SearchMap extends APIFixedConstant {
	...
	@Size(min = FL_TYPE_MIN, max = FL_TYPE_MAX, message = EM_INVALID_SEARCH_TYPE)
	@Pattern(regexp = RE_TYPE, message = EM_INVALID_SEARCH_TYPE + EM_INVALID_PATTERN)
	@ApiModelProperty(value = "searchType", required = true)
	...
	public String toString() {
		return "SearchMap [Id=" + Id + ", companyId=" + companyId + ", groupId=" + groupId + ", divisionId="
				+ divisionId + ", moduleId=" + moduleId + ", name=" + name + ", procedureName=" + procedureName
				+ ", searchType=" + searchType + ", active=" + active + ", createdBy=" + createdBy + ", modifiedBy="
